<?php
    if(!isset($product))
	  $title = 'Dashboard - Nuevo Producto';
    else 
            ...
            <div class="col-span-4">
                ...
                <div class="flex flex-col mb-6">
                    ...
                    <div class="relative">
                      ...
                      <input id="price" value="0.00" required type="number" step="0.01" name="price" class=" text-sm placeholder-gray-500 pl-10 pr-4 rounded-2xl border border-gray-400 w-full py-2 focus:outline-none focus:border-gray-800" placeholder="0.00"/>
                  </div>
                </div>
            ...
            <div class="col-span-4">
                ...
                <div class="flex flex-col mb-6">
                    ...
                    <div class="relative">
                      ...
                      <input id="price" value="<?= $product['price'] ?>" required type="number" step="0.01" name="price" class=" text-sm placeholder-gray-500 pl-10 pr-4 rounded-2xl border border-gray-400 w-full py-2 focus:outline-none focus:border-gray-800" placeholder="0.00"/>
                  </div>
                </div>
