            ...
            <form action="<?= URL::get('Auth', 'check') ?>" method="POST">
                <div class="flex flex-col mb-5">
                    ...
                    <div class="relative">
                        ...
                        <input required id="email" type="email" name="email" class="text-sm placeholder-gray-500 pl-10 pr-4 rounded-2xl border border-gray-400 w-full py-2 focus:outline-none focus:border-gray-800" placeholder="Ingresa tu email" />
                    </div>
                </div>
                <div class="flex flex-col mb-6">
                    ...
                    <div class="relative">
                        ...
                        <input required id="password" type="password" name="password" class="text-sm placeholder-gray-500 pl-10 pr-4 rounded-2xl border border-gray-400 w-full py-2 focus:outline-none focus:border-gray-80 " placeholder="Ingresa tu contraseña"/>
                    </div>
                </div>
